  ...
  return (
    <Grid container className={classes.mainContainer}>
      ...
      <Grid item xs={12} sm={9}>
        ...
        >
          {videoToPlayIndex?.sectionNumber + 1} .{' '}
          {videoToPlayIndex?.lessonNumber + 1}{' '}
          {
            videoName[videoToPlayIndex.sectionNumber][
              videoToPlayIndex.lessonNumber
            ]
          }
        </Typography>
